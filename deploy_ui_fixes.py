...
if __name__ == "__main__":
    ...
    upload_file_to_cpanel(
        local_path=r"c:\ProAG\puretego-crm\app\templates\clients\view.html",
        remote_dir="repositories/puretego-crm/app/templates/clients",
        remote_file="view.html"
    )
    
    # Restart the python app to clear template cache just in case! (Wait, Jinja2 usually auto-reloads templates in typical Flask, but wait.)
    # Touching the Passenger wsgi file restarts the app.
